...
switch ($action) {
    ...
    case 70: // Process add npc form
        ...
        if (isset($_POST['search']) && ($_POST['search'] != '')) {
            ...
            add_multiple_spawngroup_member();
            $npcid = $_REQUEST['npc'];
            header("Location: index.php?editor=spawn&z=$z&zoneid=$zoneid&npcid=$npcid");
            exit;
        }
...
function delete_spawngroup(): void
{
    check_authorization();
    global $mysql;
    $sid = $_GET['sid'];
...
function search_npc_types($search): array|string|null
{
    global $mysql;
...
function get_spawnpoints(): array|string|null
{
    global $mysql;
    $sid = $_GET['sid'];
...
function grid_info(): bool|array|string|null
{
    global $mysql, $z;
    $zid = getZoneID($z);
...
function gridpoint_info(): bool|array|string|null
{
    global $mysql, $z;
    $zid = getZoneID($z);
    $pathgrid = intval($_GET['pathgrid']);
...
function spawnevent_info(): bool|array|string|null
{
    global $mysql;
...
function spawncondition_info(): bool|array|string|null
{
    global $mysql, $z;
...
function delete_gridentry(): void
{
    global $mysql, $z;
    $zid = getZoneID($z);
    $pathgrid = intval($_GET['pathgrid']);
...
function delete_gridentries(): void
{
    global $mysql, $z;
    $zid = getZoneID($z);
    $pathgrid = intval($_GET['pathgrid']);
...
function delete_spawnevent(): void
{
    check_authorization();
    global $mysql;
    $seid = $_GET['seid'];
...
function delete_spawncondition(): void
{
    check_authorization();
    global $mysql, $z;
    $scid = $_GET['scid'];
...
function delete_spawnconditionvalue(): void
{
    check_authorization();
    global $mysql, $z;
    $scid = $_GET['scid'];
...
function spawnpoint_info(): bool|array|string|null
{
    global $mysql;
    $id = $_REQUEST['id'];
...
function update_spawnpoint(): void
{
    check_authorization();
    global $mysql;
    $id = $_POST['id'];
...
function update_gridentry(): void
{
    check_authorization();
    global $mysql, $z;
...
function view_respawn(): bool|array|string|null
{
    global $mysql;
    $spid = intval($_GET['spid']);
...
function get_spawn_condition(): array
{
    global $mysql, $z;
    $array = array();
...
function get_spawn_condition_value(): array
{
    global $mysql, $z;
    $array = array();
...
function get_spawn_event(): array
{
    global $mysql, $z;
    $array = array();
...
function update_spawnevent(): void
{
    check_authorization();
    global $mysql, $z;
...
function update_spawncondition(): void
{
    check_authorization();
    global $mysql, $z;
...
function update_spawntimer(): void
{
    check_authorization();
    global $mysql;
...
function add_spawncondition(): void
{
    check_authorization();
    global $mysql, $z;
...
function add_spawnconditionvalue(): void
{
    check_authorization();
    global $mysql, $z;
...
function search_spawngroups($search): array|string|null
{
    global $mysql;
...
function get_spawngroups_by_zone($search): array|string|null
{
    global $mysql;
    ...
    if ($results) {
        ...
        while (isset($results[$i])) {
            if (isset($lastResultID) && $lastResultID == $results[$i]['spawngroupID']) {
...
function export_grid_sql(): string
{
    global $mysql;
...
function get_npcs_by_grid(): array|string|null
{
    global $mysql;
    $pathgrid = $_GET['pathgrid'];
...
function get_import_text(): bool|string
{
    global $mysql;
    $gridid = $_GET['pathgrid'];
    $zoneid = getZoneID($_GET['z']);
