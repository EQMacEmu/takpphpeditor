...
function get_old_characters($datetime): array|string|null
{
    global $mysql;
...
function purge_characters(): void
{
    $characters = $_POST['id'];
...
function get_empty_accounts(): array|string|null
{
    global $mysql;
...
function get_recipe_activity($count): array|string|null
{
    global $mysql;
