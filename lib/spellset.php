...
function spells_info(): array|string
{
...
function spell_info(): bool|array|string|null
{
    global $mysql;
...
function update_npc_spellset(): void
{
    check_authorization();
    global $mysql, $npcid;
...
function search_spells(): array|string|null
{
    global $mysql;
    $search = $_GET['search'];
...
function change_spellset_byname(): void
{
    check_authorization();
    global $mysql, $z;
    $zid = getZoneID($z);
...
function change_spellset_byclass(): void
{
    check_authorization();
    global $mysql, $z;
    $zid = getZoneID($z);
