...
switch ($action) {
	...
	case 67: // Add Scheduled Event
		...
		break;
	case 68: // Insert Scheduled Event
		check_authorization();
		insert_scheduled_event();
		header("Location: index.php?editor=server&action=66");
		exit;
	case 69: // Edit Scheduled Event
		check_authorization();
		...
		break;
	case 70: // Update Scheduled Event
		check_authorization();
		update_scheduled_event();
		header("Location: index.php?editor=server&action=66");
		exit;
	case 71: // Delete Scheduled Event
		check_authorization();
