        ...
        <table width="100%" cellpadding="2" cellspacing="2" border="0">
          ...
          <tr>
            ...
            <td>
              ...
              <input type="text" size="5" name="min_level" value="0">
            </td>
            <td>
              <strong>Max Level:</strong><br>
              <input type="text" size="5" name="max_level" value="0">
            </td>
          </tr>
          <tr>
            <td>
              <strong>Min Expansion</strong><br>
              <input type="text" size="5" name="min_expansion" value="-1">
            </td>
            <td>&nbsp;</td>
            <td>
              <strong>Max Expansion</strong><br>
              <input type="text" size="5" name="max_expansion" value="-1">
            </td>
            <td>
              <strong>Content Flags</strong><br>
              <input type="text" size="20" name="content_flags" value="">
            </td>
            <td colspan="2">
              <strong>Content Flags Disabled</strong><br>
              <input type="text" size="20" name="content_flags_disabled" value="">
            </td>
          </tr>
          <tr>
            <td colspan="6">
