...
?>
              ...
              <td>
			    Multiplier Min:<a href="index.php?editor=loot&z=<?=$currzone?>&zoneid=<?=$currzoneid?>&npcid=<?=$npcid?>&ltid=<?=$loottable_id?>&ldid=<?=$lootdrop['id']?>&action=7"><?=$lootdrop['multiplier_min']?></a>
             </td>
              <td>
 ...
 <? if(isset($lootdrop['items']) && $lootdrop['items']): $x=0; ?>
          <tr>
            ...
            <th align="center" width="7%">Max<br>Level</th>
