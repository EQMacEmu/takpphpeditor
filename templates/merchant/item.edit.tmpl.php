          ...
          <table width="100%" cellpadding="3" cellspacing="3">
            ...
            <tr>
              ...
              <td>
                ...
                <input id="quantity" type="text" size="10" name="quantity" value="<?=$quantity?>">
              </td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              ...
              <td colspan="4">
                <fieldset style="text-align:left;">
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                      <td colspan="8" align="center"><br><input type="checkbox" id="all_classes" onChange="all_boxes_changed('classes_required[]', 'all_classes');"<?echo ($classes_required == 32767) ? " checked" : "";?>>All Classes</td>
                    </tr>
                  </table>
                </fieldset><br>
              </td>
