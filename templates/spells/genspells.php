  ...
  <table class="edit_form">
    ...
    <tr>
      <td class="edit_form_content">
        <center>
<?echo $cnt; ?> spells written.<br><?echo $lastid; ?> is the highest ID<br><b><a href="spells_en.txt">Right click and choose 'Save Link As' or 'Save Target As' to download spell file</a></b>
        </center>
      </td>
    </tr>
  </table>
