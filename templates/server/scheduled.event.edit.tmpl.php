    ...
    <div class="table_header">
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td align="right"><a onClick="return confirm('Really delete scheduled event?');" href="index.php?editor=server&id=<?=$scheduled_event['id']?>&action=71"><img src="images/remove3.gif" border="0" title="Delete Scheduled Event" alt="Delete"></a></td>
        </tr>
      </table>
    </div>
    <div class="table_content">
      <form name="edit_scheduled_event" method="post" action="index.php?editor=server&action=70">
