    ...
    <div class="table_header">
      <table width="100%" cellpadding="0" cellspacing="0">
        <tr>
          ...
          <td align="right">
            <a href="index.php?editor=server&action=67"><img src="images/add.gif" border="0" title="Create New Scheduled Event" alt="Create New Scheduled Event"></a>
          </td>
        </tr>
      </table>
    </div>
...
foreach($scheduled_events as $scheduled_event):?>
      <tr bgcolor="#<? echo ($x % 2 == 0) ? "BBBBBB" : "AAAAAA";?>">
        ...
        <td align="right"><a href="index.php?editor=server&id=<?=$scheduled_event['id']?>&action=69"><img src="images/edit2.gif" width="13" height="13" border="0" title="Edit Scheduled Event" alt="Edit"></a>&nbsp;<a onClick="return confirm('Really delete scheduled event?');" href="index.php?editor=server&id=<?=$scheduled_event['id']?>&action=71"><img src="images/remove3.gif" border="0" title="Delete Scheduled Event" alt="Delete"></a></td>
      </tr>
<?$x++;
endforeach;
else:?>
